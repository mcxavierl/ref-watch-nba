...
export const metadata: Metadata = {
  title: "NBA crew dynamics",
  description:
    "Recurring NBA referee crews ranked by combined scoring pace, whistle rate, and dominance vs members' other assignments. Historical splits only.",
  alternates: { canonical: absoluteUrl("/crews") },
};
  ...
  return (
    <div className="page-shell">
      ...
      <section className="page-hero">
        <h1 className="page-title">NBA crew dynamics</h1>
