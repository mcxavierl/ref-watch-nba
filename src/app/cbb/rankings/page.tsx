...
export const metadata: Metadata = {
  title: "CBB official tendency index",
  description:
    "Sortable CBB official tendency index by historical scoring association, whistle rate, and over-rate vs league baseline. Minimum game thresholds, descriptive only.",
  alternates: { canonical: absoluteUrl("/cbb/rankings") },
};
...
export default function NbaRankingsPage() {
  ...
  const signalCounts = Object.fromEntries(
    stats.refs.map((ref) => [
      ref.slug,
      countNotableSignals(ref, stats.meta, "cbb"),
    ]),
  );
  ...
  return (
    <div className="page-shell">
      ...
      <section className="page-hero">
        <h1 className="page-title">CBB {RANKINGS_PAGE_TITLE.toLowerCase()}</h1>
      ...
      <RankingsInsightCards synthesis={synthesis} basePath="/cbb" />
