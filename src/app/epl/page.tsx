  ...
  return (
    <div className="page-shell page-shell-slate">
      ...
      <FindingsSection
        ...
        league="EPL"
        sortExplainer="Ranked by effect size and sample depth. Standout ref×club splits and card outliers rise to the top; marginal league-wide noise is filtered out."
      />
      ...
      <MethodologyAccordion>
        <ul className="space-y-2 text-sm leading-relaxed text-zinc-600">
          ...
          <li>
            <TermHelp id="whistle-premium" />: crew avg combined goals minus
            league baseline ({refStats.meta.leagueAvgTotal}).
          </li>
          <li>
            Card, foul, and penalty analytics use historical EPL game data with
          ...
          <li>
            <ProComingSoonTease league="EPL" compact />
          </li>
        </ul>
      </MethodologyAccordion>
