...
export const metadata: Metadata = {
  title: "EPL research hub, dataset findings",
  description:
    "Ranked historical patterns from the EPL referee dataset. Effect size, sample gates, and plain-language context.",
  alternates: { canonical: absoluteUrl("/epl/research") },
};

export default function NhlResearchHubPage() {
  const findings = computeResearchFindingsForLeague("EPL");
  ...
  return (
    <div className="page-shell">
      ...
      <section className="page-hero">
        <h1 className="page-title">EPL research hub</h1>
