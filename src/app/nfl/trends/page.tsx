...
export const metadata: Metadata = {
  title: "NFL league trends, 5 seasons",
  description:
    "Five-season NFL scoring, minor penalty, and overtime trends from Ref Watch baselines. Year-over-year context in plain language.",
    ...
    <div className="page-shell">
      ...
      <section className="section-block">
        ...
        <p className="mt-6 text-sm text-zinc-600">
          Compare officials:{" "}
          <Link href="/nfl/rankings" className="font-medium text-zinc-800 hover:underline">
            NFL referee rankings →
          </Link>
        </p>
      </section>
    </div>
