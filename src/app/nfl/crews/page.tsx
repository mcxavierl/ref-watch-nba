...
export const metadata: Metadata = {
  title: "NFL crew dynamics",
  description:
    "Recurring NFL officiating crews ranked by combined scoring pace, penalty rate, and dominance vs members' other assignments. Historical splits only.",
  alternates: { canonical: absoluteUrl("/nfl/crews") },
};
  ...
  return (
    <div className="page-shell">
      ...
      <section className="page-hero">
        <h1 className="page-title">NFL crew dynamics</h1>
        <p className="page-lead">
          {crewDominanceSummary(entries, "nfl")} ({range}). Pace and penalty
