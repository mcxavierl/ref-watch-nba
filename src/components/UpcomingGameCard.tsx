...
export function UpcomingGameCard({
  ...
  return (
    <article
      className={`upcoming-game-card h-[280px] flex flex-col justify-between overflow-hidden bg-slate-900/60 border border-slate-800 rounded-2xl p-4${
    ...
    >
      <div className="upcoming-game-card__body shrink-0">
