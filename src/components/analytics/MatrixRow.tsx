  ...
  return (
    ...
    >
      <div className="team-ref-matrix-row-main">
        ...
        <div className="team-ref-matrix-expand master-table-expand-cell">
          <button
            type="button"
        ...
        <span
          className={`team-ref-matrix-stat team-ref-matrix-stat--baseline tabular-nums team-ref-matrix-stat--${winRateTone} master-table-metric-secondary`}
          title={baselineTitle}
        >
          {variance}
        </span>
        <span className="team-ref-matrix-stat team-ref-matrix-stat--close tabular-nums master-table-metric-secondary">
        ...
        <span
          className={`team-ref-matrix-stat team-ref-matrix-stat--whistle tabular-nums team-ref-matrix-stat--${whistleTone} master-table-metric-secondary`}
      ...
      {expanded ? (
        <div className="team-ref-matrix-row-details md:hidden">
          <div className="team-ref-matrix-row-details-stat">
            ...
            <span
              className={`team-ref-matrix-row-details-value tabular-nums team-ref-matrix-stat--${winRateTone}`}
            >
              {variance}
            </span>
          </div>
          <div className="team-ref-matrix-row-details-stat">
            ...
            <span className="team-ref-matrix-row-details-value tabular-nums">
              {closeGameStats.fraction}
            </span>
          </div>
          <div className="team-ref-matrix-row-details-stat">
            ...
            <span
              className={`team-ref-matrix-row-details-value tabular-nums team-ref-matrix-stat--${whistleTone}`}
            >
              {whistleDiff}
            </span>
          </div>
