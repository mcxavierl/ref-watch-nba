...
const LEAGUE_ID_TO_FINDING: Record<(typeof VERIFIED_LIVE_LEAGUE_IDS)[number], FindingLeague> = {
  nba: "NBA",
  nfl: "NFL",
  nhl: "NHL",
  epl: "EPL",
...
export function computeRefGeoCorrelations(
  ...
  const findingLeague =
    LEAGUE_ID_TO_FINDING[leagueId as (typeof VERIFIED_LIVE_LEAGUE_IDS)[number]];
