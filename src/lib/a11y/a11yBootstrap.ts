...
)});function applyResolved(color,contrast,text,bf){d.dataset.contrast=contrast;d.dataset.color=color;d.dataset.theme=color;d.dataset.text=text;if(bf==="atkinson")d.dataset.bodyFont="atkinson";else delete d.dataset.bodyFont;if(color==="dark")d.classList.add("dark");else d.classList.remove("dark");}if(!r){applyResolved("dark","default","default","default");return;}var p=JSON.parse(r);if(!p||typeof p!=="object")return;var contrast=p.contrast==="high"?"high":"default";var pref=p.colorMode;var color=(pref==="light")?"light":"dark";var text=p.textSize==="large"?"large":"default";var f=p.font;var bf=(f==="atkinson"||f==="dyslexia")?"atkinson":"default";applyResolved(color,contrast,text,bf);}catch(e){}})();`;
